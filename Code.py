...
mars=CelestialBodies(position=(sheet['B6'].value,sheet['C6'].value,sheet['D6'].value),orbitSpeed =(sheet['E6'].value, sheet['F6'].value ,sheet['G6'].value),rotation=(sheet['H6'].value,sheet['I6'].value,sheet['J6'].value),orbitRadius=sheet['K6'].value, rotationSpeed=[0,868.22,0],scale=sheet['O6'].value,texture=sheet['P6'].value)
jupiter=CelestialBodies(position=(sheet['B7'].value,sheet['C7'].value,sheet['D7'].value),orbitSpeed =(sheet['E7'].value, sheet['F7'].value ,sheet['G7'].value),rotation=(sheet['H7'].value,sheet['I7'].value,sheet['J7'].value),orbitRadius=sheet['K7'].value, rotationSpeed=[0,47051,0],scale=sheet['O7'].value,texture=sheet['P7'].value)
saturn=CelestialBodies(position=(sheet['B8'].value,sheet['C8'].value,sheet['D8'].value),orbitSpeed =(sheet['E8'].value, sheet['F8'].value ,sheet['G8'].value),rotation=(sheet['H8'].value,sheet['I8'].value,sheet['J8'].value),orbitRadius=sheet['K8'].value, rotationSpeed=[0,34821,0],scale=sheet['O8'].value,texture=sheet['P8'].value)
uranus=CelestialBodies(position=(sheet['B9'].value,sheet['C9'].value,sheet['D9'].value),orbitSpeed =(sheet['E9'].value, sheet['F9'].value ,sheet['G9'].value),rotation=(sheet['H9'].value,sheet['I9'].value,sheet['J9'].value),orbitRadius=sheet['K9'].value, rotationSpeed=[0,9320,0],scale=sheet['O9'].value,texture=sheet['P9'].value)
neptune=CelestialBodies(position=(sheet['B10'].value,sheet['C10'].value,sheet['D10'].value),orbitSpeed =(sheet['E10'].value, sheet['F10'].value ,sheet['G10'].value),rotation=(sheet['H10'].value,sheet['I10'].value,sheet['J10'].value),orbitRadius=sheet['K10'].value, rotationSpeed=[0,9660,0],scale=sheet['O10'].value,texture=sheet['P10'].value)
